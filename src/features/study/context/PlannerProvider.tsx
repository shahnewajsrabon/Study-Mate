...
import { generateSmartPath } from '../lib/aiEngine.ts';
import type { ScheduledSession, MajorExam } from '../types/study.ts';
import { PlannerContext, type PlannerContextType } from './PlannerContextObject.tsx';
